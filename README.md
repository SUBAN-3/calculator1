A simple Java console calculator that works basic calculations. It performs basic arithmetic operations (+, -, *, /) and supports continuous calculations using the result of previous operations.
